  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp1 = tanf((fConst0 * max(fRec1[0], (float)20)));
			...
			float fTemp26 = sqrtf(max((float)0, fTemp20));
			float fTemp27 = (float)input0[i];
			float fTemp28 = ((fTemp27 * fTemp26) + ((0 - fTemp19) * fRec4[1]));
			float fTemp29 = sqrtf(max((float)0, fTemp24));
			...
			float fTemp31 = sqrtf(max((float)0, fTemp8));
			float fTemp32 = (((fTemp31 * fTemp30) / fTemp17) + ((0 - fTemp7) * fRec2[1]));
			float fTemp33 = sqrtf(max((float)0, fTemp13));
